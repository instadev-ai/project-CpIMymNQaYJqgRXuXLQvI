...
const Expenses = () => {
  ...
  const filteredExpenses = expenses.filter(expense => {
    ...
    const matchesSearch = expense.description.toLowerCase().includes(searchTerm.toLowerCase()) ||
                          ...
                          (expense.group && expense.group.toLowerCase().includes(searchTerm.toLowerCase()));
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="all" className="w-full">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex flex-col">
                            ...
                            <p className="text-xs text-gray-500">
                              {expense.date} • {expense.group || "General"}
                            </p>
                          </div>
          ...
          <TabsContent value="you-owe" className="mt-0">
            <div className="bg-white shadow overflow-hidden sm:rounded-md">
              {filteredExpenses.filter(e => e.paidBy !== "You" && e.participants && e.participants.includes("You")).length > 0 ? (
                <ul className="divide-y divide-gray-200">
                  {filteredExpenses
                    .filter(e => e.paidBy !== "You" && e.participants && e.participants.includes("You"))
                    .map((expense) => (
                      <li key={expense.id} className="hover:bg-gray-50">
                        <div className="px-4 py-4 sm:px-6">
                          <div className="flex items-center justify-between">
